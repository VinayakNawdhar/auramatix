      ...
      <div className="pb-16">
        ...
        <div className="py-3">
          ...
          <div className="flex flex-col gap-3 mt-5">
            <div className="p-2 border-2 border-green-400 bg-green-100 rounded-xl text-[12px]">
              <h1>Extra Rs.150 OFF</h1>
              <p>Rs. 150 OFF on minimum purchase of 400</p>
              <button className="px-5 mt-2 py-1 border-2 rounded-xl border-gray-400">
                Applied
              </button>
            </div>
            <div className="p-2 border-2 bg-[#F5ECDF] border-[#b7a58a] rounded-xl text-[12px]">
