...
const ProductCard = () => {
    return (
        <div className='bg-white w-[168px] h-64 rounded-xl overflow-hidden'>
            ...
            <div className='px-2 flex flex-col justify-center h-20'>
                ...
                <p className='text-[10px]'>For Anti-aging & Brightening</p>
                <p className='font-semibold text-sm mt-2'>Rs. 249 /-</p>
            </div>
        </div>
    )
}
